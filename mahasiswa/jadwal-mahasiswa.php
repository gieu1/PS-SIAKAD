...
<html lang="id" class="h-full">
 <head>
  ...
  <title>Jadwal Mahasiswa - SIAKAD</title>
 ...
 <body class="h-full w-full bg-gradient-to-br from-blue-50 to-blue-100">
  ...
  <script>
    ...
    function renderJadwalMahasiswa() {
        const mhs = currentUser;
        const jadwalMhs = jadwalData.filter(j => j.prodi === mhs.prodi);

        return `
            ${renderHeader('Jadwal Perkuliahan')}
    ...
    async function init() {
        ...
        document.getElementById('content').innerHTML = renderJadwalMahasiswa();
    }
